...
function SigninPresentation({handleUserInput, handleFormSubmit}){
    return (
        <>
            <section className="text-gray-600 body-font">
                <div className = "flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
                    ...
                    <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0" onSubmit={handleFormSubmit} >
                        ...
                        <h2 className="mb-5 text-3xl font-bold text-gray-900 title-font ">Sign in</h2>

                     
                        <div className="relative mb-4">
                            <label htmlFor="emailorMobileNumber" className="text-sm leading-7 text-gray-600 ">Email/ Mobile Number <span className="text-red-600">*</span></label>
                            <input 
                                type="text" 
                                ...
                                placeholder="John@example.com / 0123456789"
