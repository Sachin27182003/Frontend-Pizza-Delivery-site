            ...
            <section className="text-gray-600 body-font">
                <div className = "flex flex-wrap items-center h-screen px-10 py-6 mx-auto">
                    ...
                    <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0" onSubmit = { handleFormSubmit }>                   
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="mobileNumber" className="text-sm leading-7 text-gray-600 "> Mobile Number <span className="text-blue-500">91/+91 is optional</span> <span className="text-red-600">*</span></label>
                            <input 
                                type="tel" 
                                id="mobileNumber" 
                                name="mobileNumber"
                        ...
                        <p className="text-[0.95rem] mt-3 text-xs text-gray-500">Already have an account? <Link to="/auth/Signin" className="text-yellow-500" >Sign in</Link> </p>
